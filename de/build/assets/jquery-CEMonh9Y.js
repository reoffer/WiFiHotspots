    ...
    return jn || (jn = 1, (function(qn) {
        (function(j, Je) {
            ...
            function Ft(e, t, n) {
                ...
                if (u.text = e, t)
                    for (r in Hn) o = t[r] || t.getAttribute && t.getAttribute(r), o && u.setAttribute(r, o);
            ...
            (function() {
                ...
                function _(s, l, p, g) {
                    ...
                    if (!g && (me(l), l = l || a, f)) {
                        ...
                        if (!V[s + " "] && (!d || !d.test(s))) {
                            if (A = s, N = l, P === 1 && (jt.test(s) || Ge.test(s))) {
                                for (N = qt.test(s) && Lt(l.parentNode) || l, (N != l || !q.scope) && ((w = l.getAttribute("id")) ? w = i.escapeSelector(w) : l.setAttribute("id", w = x)), O = Ye(s), m = O.length; m--;) O[m] = (w ? "#" + w : ":scope") + " " + st(O[m]);
                                A = O.join(",")
                            }
                            try {
                ...
                function me(s) {
                    ...
                    return p == a || p.nodeType !== 9 || !p.documentElement || (a = p, c = a.documentElement, f = !i.isXMLDoc(a), y = c.matches || c.webkitMatchesSelector || c.msMatchesSelector, c.msMatchesSelector && pe != a && (l = a.defaultView) && l.top !== l && l.addEventListener("unload", Or), q.getById = Me(function(g) {
                ...
                _.matches = function(s, l) {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function(s) {
                            var l, p = !s[6] && s[2];
                            return ce.CHILD.test(s[0]) ? null : (s[3] ? s[2] = s[4] || s[5] || "" : p && fe.test(p) && (l = Ye(p, !0)) && (l = p.indexOf(")", p.length - l) - p.length) && (s[0] = s[0].slice(0, l), s[2] = p.slice(0, l)), s.slice(0, 3))
                        }
                    },
                    filter: {
                        TAG: function(s) {
                            ...
                            return g === 1 && v === 0 ? function(C) {
                                ...
                                if (ne) {
                                    ...
                                    if (K = [T ? ne.firstChild : ne.lastChild], T && Re) {
                                        for (P = ne[x] || (ne[x] = {}), N = P[s] || [], F = N[0] === h && N[1], G = F && N[2], E = F && ne.childNodes[F]; E = ++F && E && E[X] || (G = F = 0) || K.pop();)
                                            if (E.nodeType === 1 && ++G && E === C) {
                                                P[s] = [h, F, G];
                                                break
                                            }
                                    } else if (Re && (P = C[x] || (C[x] = {}), N = P[s] || [], F = N[0] === h && N[1], G = F), G === !1)
                                        for (;
                                            (E = ++F && E && E[X] || (G = F = 0) || K.pop()) && !((w ? $(E, le) : E.nodeType === 1) && ++G && (Re && (P = E[x] || (E[x] = {}), P[s] = [h, G]), E === C)););
                        ...
                        PSEUDO: function(s, l) {
                            ...
                            return g[x] ? g(l) : g.length > 1 ? (p = [s, s, "", l], t.setFilters.hasOwnProperty(s.toLowerCase()) ? ie(function(v, m) {
                    ...
                    pseudos: {
                        ...
                        lang: ie(function(s) {
                            return Qe.test(s || "") || _.error("unsupported lang: " + s), s = s.replace(ye, ve).toLowerCase(),
                                function(l) {
                                    var p;
                                    do
                ...
                function Ot(s, l, p, g, v, m) {
                    return g && !g[x] && (g = Ot(g)), v && !v[x] && (v = Ot(v, m)), ie(function(T, w, C, O) {
                        var A, N, P, E, F = [],
                            K = [],
                            X = w.length,
                        ...
                        if (p = t.relative[s[w].type]) A = [ft(Ht(A), p)];
                            ...
                            if (p = t.filter[s[w].type].apply(null, s[w].matches), p[x]) {
                                ...
                                return Ot(w > 1 && Ht(A), w > 1 && st(s.slice(0, w - 1).concat({
                                    value: s[w - 2].type === " " ? "*" : ""
                                })).replace(_e, "$1"), p, w < g && Pt(s.slice(w, g)), g < v && Pt(s = s.slice(g)), g < v && st(s))
                            }
                            A.push(p)
                        }
                    return Ht(A)
                ...
                function Mt(s, l) {
                    var p, g = [],
                        ...
                        m = H[s + " "];
                    if (!m) {
                        for (l || (l = Ye(s)), p = l.length; p--;) m = Pt(l[p]), m[x] ? g.push(m) : v.push(m);
                ...
                q.sortStable = x.split("").sort(z).join("") === x, me(), q.sortDetached = Me(function(s) {
                    return s.compareDocumentPosition(a.createElement("fieldset")) & 1
                }), i.find = _, i.expr[":"] = i.expr.pseudos, i.unique = i.uniqueSort, _.compile = Mt, _.select = kn, _.setDocument = me, _.tokenize = Ye, _.escape = i.escapeSelector, _.getText = i.text, _.isXML = i.isXMLDoc, _.selectors = i.expr, _.support = i.support, _.uniqueSort = i.uniqueSort
            })();
                ...
                Fn = i.fn.init = function(e, t, n) {
                    ...
                    if (n = n || Vt, typeof e == "string")
                        if (e[0] === "<" && e[e.length - 1] === ">" && e.length >= 3 ? r = [null, e, null] : r = Wn.exec(e), r && (r[1] || !t))
                            if (r[1]) {
                                if (t = t instanceof i ? t[0] : t, i.merge(this, i.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : k, !0)), Ut.test(r[1]) && i.isPlainObject(t))
            ...
            i.Callbacks = function(e) {
                ...
                var t, n, r, o, u = [],
                    ...
                    d = {
                        add: function() {
                            return u && (n && !t && (c = u.length - 1, a.push(n)), (function y(x) {
                                i.each(x, function(h, b) {
                                    L(b) ? (!e.unique || !d.has(b)) && u.push(b) : b && b.length && De(b) !== "string" && y(b)
                                })
                        ...
                        remove: function() {
                            return i.each(arguments, function(y, x) {
                                for (var h;
                                    (h = i.inArray(x, u, h)) > -1;) u.splice(h, 1), h <= c && c--
                            }), this
                        },
                        has: function(y) {
                        ...
                        fireWith: function(y, x) {
                            return o || (x = x || [], x = [y, x.slice ? x.slice() : x], a.push(x), t || f()), this
                        },
                        fire: function() {
                                    ...
                                    return function() {
                                        var D = this,
                                            ...
                                            H = function() {
                                                var z, ae;
                                                if (!(y < f)) {
                                                    if (z = h.apply(D, R), z === x.promise()) throw new TypeError("Thenable self-resolution");
                                                    ae = z && (typeof z == "object" || typeof z == "function") && z.then, L(ae) ? b ? ae.call(z, d(f, x, ke, b), d(f, x, et, b)) : (f++, ae.call(z, d(f, x, ke, b), d(f, x, et, b), d(f, x, ke, x.notifyWith))) : (h !== ke && (D = void 0, R = [z]), (b || x.resolveWith)(D, R))
                                                }
                                            },
                                            V = b ? H : function() {
                                                try {
                                                    ...
                                                    i.Deferred.exceptionHook && i.Deferred.exceptionHook(z, V.error), y + 1 >= f && (h !== et && (D = void 0, R = [z]), x.rejectWith(D, R))
                                                }
                                            };
            ...
            i.fn.ready = function(e) {
                ...
                readyWait: 1,
                ready: function(e) {
                    (e === !0 ? --i.readyWait : i.isReady) || (i.isReady = !0, !(e !== !0 && --i.readyWait > 0) && gt.resolveWith(k, [i]))
                }
            ...
            var he = function(e, t, n, r, o, u, a) {
                    ...
                    } else if (r !== void 0 && (o = !0, L(r) || (a = !0), d && (a ? (t.call(e, r), t = null) : (d = t, t = function(y, x, h) {
                            return d.call(i(y), h)
                        })), t))
            ...
            function qe(e, t) {
                for (var n, r, o = [], u = 0, a = e.length; u < a; u++) r = e[u], r.style && (n = r.style.display, t ? (n === "none" && (o[u] = S.get(r, "display") || null, o[u] || (r.style.display = "")), r.style.display === "" && nt(r) && (o[u] = Zn(r))) : n !== "none" && (o[u] = "none", S.set(r, "display", n)));
            ...
            function tn(e, t, n, r, o) {
                for (var u, a, c, f, d, y, x = t.createDocumentFragment(), h = [], b = 0, D = e.length; b < D; b++)
                    if (u = e[b], u || u === 0)
                        if (De(u) === "object") i.merge(h, u.nodeType ? [u] : u);
                        else if (!er.test(u)) h.push(t.createTextNode(u));
                else {
                    for (a = a || x.appendChild(t.createElement("div")), c = (Zt.exec(u) || ["", ""])[1].toLowerCase(), f = ee[c] || ee._default, a.innerHTML = f[1] + i.htmlPrefilter(u) + f[2], y = f[0]; y--;) a = a.lastChild;
                ...
                for (x.textContent = "", b = 0; u = h[b++];) {
                    ...
                    if (d = je(u), a = Y(x.appendChild(u), "script"), d && yt(a), n)
            ...
            i.event = {
                ...
                add: function(e, t, n, r, o) {
                    var u, a, c, f, d, y, x, h, b, D, R, H = S.get(e);
                    if (We(e))
                        for (n.handler && (u = n, n = u.handler, o = u.selector), o && i.find.matchesSelector(Te, o), n.guid || (n.guid = i.guid++), (f = H.events) || (f = H.events = Object.create(null)), (a = H.handle) || (a = H.handle = function(V) {
                            ...
                            }), t = (t || "").match(oe) || [""], d = t.length; d--;) c = nn.exec(t[d]) || [], b = R = c[1], D = (c[2] || "").split(".").sort(), b && (x = i.event.special[b] || {}, b = (o ? x.delegateType : x.bindType) || b, x = i.event.special[b] || {}, y = i.extend({
                            type: b,
                            origType: R,
                            data: r,
                            handler: n,
                            ...
                            namespace: D.join(".")
                        }, u), (h = f[b]) || (h = f[b] = [], h.delegateCount = 0, (!x.setup || x.setup.call(e, r, D, a) === !1) && e.addEventListener && e.addEventListener(b, a)), x.add && (x.add.call(e, y), y.handler.guid || (y.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, y) : h.push(y), i.event.global[b] = !0)
                },
                remove: function(e, t, n, r, o) {
                    var u, a, c, f, d, y, x, h, b, D, R, H = S.hasData(e) && S.get(e);
                    if (!(!H || !(f = H.events))) {
                        for (t = (t || "").match(oe) || [""], d = t.length; d--;) {
                            if (c = nn.exec(t[d]) || [], b = R = c[1], D = (c[2] || "").split(".").sort(), !b) {
                                for (b in f) i.event.remove(e, b + t[d], n, r, !0);
                                continue
                            }
                            for (x = i.event.special[b] || {}, b = (r ? x.delegateType : x.bindType) || b, h = f[b] || [], c = c[2] && new RegExp("(^|\\.)" + D.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = u = h.length; u--;) y = h[u], (o || R === y.origType) && (!n || n.guid === y.guid) && (!c || c.test(y.namespace)) && (!r || r === y.selector || r === "**" && y.selector) && (h.splice(u, 1), y.selector && h.delegateCount--, x.remove && x.remove.call(e, y));
                            a && !h.length && ((!x.teardown || x.teardown.call(e, D, H.handle) === !1) && i.removeEvent(e, b, H.handle), delete f[b])
                        }
            ...
            function Oe(e, t, n, r) {
                ...
                var o, u, a, c, f, d, y = 0,
                    ...
                    b = t[0],
                    D = L(b);
                if (D || x > 1 && typeof b == "string" && !q.checkClone && nr.test(b)) return e.each(function(R) {
                    var H = e.eq(R);
                    D && (t[0] = b.call(this, R, H.html())), Oe(H, t, n, r)
                });
                if (x && (o = tn(t, e[0].ownerDocument, !1, e, r), u = o.firstChild, o.childNodes.length === 1 && (o = u), u || r)) {
                    for (a = i.map(Y(o, "script"), ir), c = a.length; y < x; y++) f = o, y !== h && (f = i.clone(f, !0, !0), c && i.merge(a, Y(f, "script"))), n.call(e[y], f, y);
                    if (c)
                        for (d = a[a.length - 1].ownerDocument, i.map(a, or), y = 0; y < c; y++) f = a[y], en.test(f.type || "") && !S.access(f, "globalEval") && i.contains(d, f) && (f.src && (f.type || "").toLowerCase() !== "module" ? i._evalUrl && !f.noModule && i._evalUrl(f.src, {
            ...
            i.extend({
                ...
                clone: function(e, t, n) {
                    ...
                    if (!q.noCloneChecked && (e.nodeType === 1 || e.nodeType === 11) && !i.isXMLDoc(e))
                        for (a = Y(c), u = Y(e), r = 0, o = u.length; r < o; r++) ur(u[r], a[r]);
                    if (t)
                        if (n)
            ...
            (function() {
                ...
                var n, r, o, u, a, c, f = k.createElement("div"),
                ...
                d.style && (d.style.backgroundClip = "content-box", d.cloneNode(!0).style.backgroundClip = "", q.clearCloneStyle = d.style.backgroundClip === "content-box", i.extend(q, {
                    ...
                    reliableTrDimensions: function() {
                        var y, x, h, b;
                        return a == null && (y = k.createElement("table"), x = k.createElement("tr"), h = k.createElement("div"), y.style.cssText = "position:absolute;left:-11111px;border-collapse:separate", x.style.cssText = "box-sizing:content-box;border:1px solid", x.style.height = "1px", h.style.height = "9px", h.style.display = "block", Te.appendChild(y).appendChild(x).appendChild(h), b = j.getComputedStyle(x), a = parseInt(b.height, 10) + parseInt(b.borderTopWidth, 10) + parseInt(b.borderBottomWidth, 10) === x.offsetHeight, Te.removeChild(y)), a
                    }
                }))
            })();

            function ze(e, t, n) {
                var r, o, u, a, c = bt.test(t),
                    f = e.style;
                return n = n || it(e), n && (a = n.getPropertyValue(t) || n[t], c && a && (a = a.replace(_e, "$1") || void 0), a === "" && !je(e) && (a = i.style(e, t)), !q.pixelBoxStyles() && xt.test(a) && ar.test(t) && (r = f.width, o = f.minWidth, u = f.maxWidth, f.minWidth = f.maxWidth = f.width = a, a = n.width, f.width = r, f.minWidth = o, f.maxWidth = u)), a !== void 0 ? a + "" : a
            }
            ...
            i.extend({
                ...
                css: function(e, t, n, r) {
                    var o, u, a, c = ue(t),
                        f = bt.test(t);
                    return f || (t = mt(c)), a = i.cssHooks[t] || i.cssHooks[c], a && "get" in a && (o = a.get(e, !0, n)), o === void 0 && (o = ze(e, t, r)), o === "normal" && t in dn && (o = dn[t]), n === "" || n ? (u = parseFloat(o), n === !0 || isFinite(u) ? u || 0 : o) : o
                }
            }), i.each(["height", "width"], function(e, t) {
                i.cssHooks[t] = {
                    get: function(n, r, o) {
                        if (r) return fr.test(i.css(n, "display")) && (!n.getClientRects().length || !n.getBoundingClientRect().width) ? an(n, cr, function() {
                            return hn(n, t, o)
                        }) : hn(n, t, o)
                    },
                    set: function(n, r, o) {
                        var u, a = it(n),
                            ...
                            y = o ? Tt(n, t, o, d, a) : 0;
                        return d && c && (y -= Math.ceil(n["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(a[t]) - Tt(n, t, "border", !1, a) - .5)), y && (u = $e.exec(r)) && (u[3] || "px") !== "px" && (n.style[t] = r, r = i.css(n, t)), pn(n, r, y)
                    }
                }
            }), i.cssHooks.marginLeft = sn(q.reliableMarginLeft, function(e, t) {
                if (t) return (parseFloat(ze(e, "marginLeft")) || e.getBoundingClientRect().left - an(e, {
                    marginLeft: 0
                }, function() {
            ...
            var Pe, ot, lr = /^(?:toggle|show|hide)$/,
                dr = /queueHooks$/;

            function Ct() {
                ot && (k.hidden === !1 && j.requestAnimationFrame ? j.requestAnimationFrame(Ct) : j.setTimeout(Ct, i.fx.interval), i.fx.tick())
            }
            ...
            function pr(e, t, n) {
                var r, o, u, a, c, f, d, y, x = "width" in t || "height" in t,
                    h = this,
                    b = {},
                    D = e.style,
                    R = e.nodeType && nt(e),
                ...
                if (f = !i.isEmptyObject(t), !(!f && i.isEmptyObject(b))) {
                    x && e.nodeType === 1 && (n.overflow = [D.overflow, D.overflowX, D.overflowY], d = H && H.display, d == null && (d = S.get(e, "display")), y = i.css(e, "display"), y === "none" && (d ? y = d : (qe([e], !0), d = e.style.display || d, y = i.css(e, "display"), qe([e]))), (y === "inline" || y === "inline-block" && d != null) && i.css(e, "float") === "none" && (f || (h.done(function() {
                        D.display = d
                    }), d == null && (y = D.display, d = y === "none" ? "" : y)), D.display = "inline-block")), n.overflow && (D.overflow = "hidden", h.always(function() {
                        D.overflow = n.overflow[0], D.overflowX = n.overflow[1], D.overflowY = n.overflow[2]
                    })), f = !1;
                    for (r in b) f || (H ? "hidden" in H && (R = H.hidden) : H = S.access(e, "fxshow", {
                        display: d
            ...
            function re(e, t, n) {
                var r, o, u = 0,
                    ...
                    f = function() {
                        if (o) return !1;
                        for (var x = Pe || gn(), h = Math.max(0, d.startTime + d.duration - x), b = h / d.duration || 0, D = 1 - b, R = 0, H = d.tweens.length; R < H; R++) d.tweens[R].run(D);
                ...
                stop: function(e, t, n) {
                    ...
                    return typeof e != "string" && (n = t, t = e, e = void 0), t && this.queue(e || "fx", []), this.each(function() {
                        ...
                        if (u) c[u] && c[u].stop && r(c[u]);
                            ...
                            for (u in c) c[u] && c[u].stop && dr.test(u) && r(c[u]);
...
`) : e)), t
            ...
            i.extend(i.event, {
                trigger: function(e, t, n, r) {
                    var o, u, a, c, f, d, y, x, h = [n || k],
                        b = Ie.call(e, "type") ? e.type : e,
                        D = Ie.call(e, "namespace") ? e.namespace.split(".") : [];
                    if (u = x = a = n = n || k, !(n.nodeType === 3 || n.nodeType === 8) && !bn.test(b + i.event.triggered) && (b.indexOf(".") > -1 && (D = b.split("."), b = D.shift(), D.sort()), f = b.indexOf(":") < 0 && "on" + b, e = e[i.expando] ? e : new i.Event(b, typeof e == "object" && e), e.isTrigger = r ? 2 : 3, e.namespace = D.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + D.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = t == null ? [e] : i.makeArray(t, [e]), y = i.event.special[b] || {}, !(!r && y.trigger && y.trigger.apply(n, t) === !1))) {
                        if (!r && !y.noBubble && !Ae(n)) {
                            for (c = y.delegateType || b, bn.test(c + b) || (u = u.parentNode); u; u = u.parentNode) h.push(u), a = u;
                            a === (n.ownerDocument || k) && h.push(a.defaultView || a.parentWindow || j)
                        }
                        for (o = 0;
                            (u = h[o++]) && !e.isPropagationStopped();) x = u, e.type = o > 1 ? c : y.bindType || b, d = (S.get(u, "events") || Object.create(null))[e.type] && S.get(u, "handle"), d && d.apply(u, t), d = f && u[f], d && d.apply && We(u) && (e.result = d.apply(u, t), e.result === !1 && e.preventDefault());
                        return e.type = b, !r && !e.isDefaultPrevented() && (!y._default || y._default.apply(h.pop(), t) === !1) && We(n) && f && L(n[b]) && !Ae(n) && (a = n[f], a && (n[f] = null), i.event.triggered = b, e.isPropagationStopped() && x.addEventListener(b, mn), n[b](), e.isPropagationStopped() && x.removeEventListener(b, mn), i.event.triggered = void 0, a && (n[f] = a)), e.result
                    }
                },
            ...
            function Et(e, t, n, r) {
                ...
                if (Array.isArray(t)) i.each(t, function(u, a) {
                    n || xr.test(e) ? r(e, a) : Et(e + "[" + (typeof a == "object" && a != null ? u : "") + "]", a, n, r)
                });
            ...
            i.param = function(e, t) {
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var e = this.type;
                        return this.name && !i(this).is(":disabled") && mr.test(this.nodeName) && !br.test(e) && (this.checked || !Be.test(e))
                    }).map(function(e, t) {
                        var n = i(this).val();
...
`)
            ...
            function En(e, t, n, r) {
                ...
                function a(c) {
                    ...
                    return o[c] = !0, i.each(e[c] || [], function(d, y) {
                        var x = y(t, n, r);
                        if (typeof x == "string" && !u && !o[x]) return t.dataTypes.unshift(x), a(x), !1;
                        if (u) return !(f = x)
                    }), f
                }
            ...
            i.extend({
                ...
                ajax: function(e, t) {
                    ...
                    var n, r, o, u, a, c, f, d, y, x, h = i.ajaxSetup({}, t),
                        b = h.context || h,
                        D = h.context && (b.nodeType || b.jquery) ? i(b) : i.event,
                        R = i.Deferred(),
                        ...
                        M = {
                            ...
                            getResponseHeader: function(I) {
                                ...
                                if (f) {
                                    if (!u)
                                        for (u = {}; B = Sr.exec(o);) u[B[1].toLowerCase() + " "] = (u[B[1].toLowerCase() + " "] || []).concat(B[2]);
                                    B = u[I.toLowerCase() + " "]
                                }
                    ...
                    d = i.event && h.global, d && i.active++ === 0 && i.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ar.test(h.type), r = h.url.replace(Cr, ""), h.hasContent ? h.data && h.processData && (h.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (h.data = h.data.replace(Tr, "+")) : (x = h.url.slice(r.length), h.data && (h.processData || typeof h.data == "string") && (r += (St.test(r) ? "&" : "?") + h.data, delete h.data), h.cache === !1 && (r = r.replace(wr, "$1"), x = (St.test(r) ? "&" : "?") + "_=" + xn.guid++ + x), h.url = r + x), h.ifModified && (i.lastModified[r] && M.setRequestHeader("If-Modified-Since", i.lastModified[r]), i.etag[r] && M.setRequestHeader("If-None-Match", i.etag[r])), (h.data && h.hasContent && h.contentType !== !1 || t.contentType) && M.setRequestHeader("Content-Type", h.contentType), M.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + (h.dataTypes[0] !== "*" ? ", " + wn + "; q=0.01" : "") : h.accepts["*"]);
                    for (y in h.headers) M.setRequestHeader(y, h.headers[y]);
                    if (h.beforeSend && (h.beforeSend.call(b, M, h) === !1 || f)) return M.abort();
            ...
            q.cors = !!Xe && "withCredentials" in Xe, q.ajax = Xe = !!Xe, i.ajaxTransport(function(e) {
                var t, n;
                if (q.cors || Xe && !e.crossDomain) return {
                    send: function(r, o) {
                        var u, a = e.xhr();
                        ...
                        t = function(c) {
                            return function() {
                                t && (t = n = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, c === "abort" ? a.abort() : c === "error" ? typeof a.status != "number" ? o(0, "error") : o(a.status, a.statusText) : o(jr[a.status] || a.status, a.statusText, (a.responseType || "text") !== "text" || typeof a.responseText != "string" ? {
                                    binary: a.response
                                } : {
                                    text: a.responseText
            ...
            i.ajaxSetup({
                ...
                setOffset: function(e, t, n) {
                    var r, o, u, a, c, f, d, y = i.css(e, "position"),
                        x = i(e),
                        h = {};
                    y === "static" && (e.style.position = "relative"), c = x.offset(), u = i.css(e, "top"), f = i.css(e, "left"), d = (y === "absolute" || y === "fixed") && (u + f).indexOf("auto") > -1, d ? (r = x.position(), a = r.top, o = r.left) : (a = parseFloat(u) || 0, o = parseFloat(f) || 0), L(t) && (t = t.call(e, n, i.extend({}, c))), t.top != null && (h.top = t.top - c.top + a), t.left != null && (h.left = t.left - c.left + o), "using" in t ? t.using.call(e, h) : x.css(h)
                }
            }, i.fn.extend({
                offset: function(e) {
                ...
                i.cssHooks[t] = sn(q.pixelPosition, function(n, r) {
                    if (r) return r = ze(n, t), xt.test(r) ? i(n).position()[t] + "px" : r
                })
            }), i.each({
                Height: "height",
                Width: "width"
                ...
                i.each({
                    ...
                    i.fn[r] = function(o, u) {
                        ...
                        return he(this, function(f, d, y) {
                            var x;
                            return Ae(f) ? r.indexOf("outer") === 0 ? f["inner" + e] : f.document.documentElement["client" + e] : f.nodeType === 9 ? (x = f.documentElement, Math.max(f.body["scroll" + e], x["scroll" + e], f.body["offset" + e], x["offset" + e], x["client" + e])) : y === void 0 ? i.css(f, d, c) : i.style(f, d, y, c)
                        }, t, a ? o : void 0, a)
                    }
                })
